...
all: data/cleaned_forestfires.csv img/EDA.png data/null_distribution_two_means.csv img/Result.png reports/report.md reports/report.md
...
clean:
	...
	rm -f img/EDA.png
	rm -f img/Estimation_and_CI_Plot.png
